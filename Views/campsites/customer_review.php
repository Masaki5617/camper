...
<body>
  <div class ="customer_review_head"> 
    <a class ="back" href="campsite/detail_campsite.php?id=<?=htmlspecialchars($_SESSION["id"]["id"] ?? "",ENT_QUOTES,"UTF-8");?>"><</a>
    <h2>カスタマーレビュー</h2>
  </div>
  ...
  <div class ="customer">
    <div class ="evaluation">
      ...
      <a href="post/post.php?id=<?=htmlspecialchars($_SESSION["id"]["id"],ENT_QUOTES,"UTF-8");?>">&nbsp&nbsp&nbspレビューを書く</a>
      <?php endif?>
    </div>
    ...
    <div class ="edit">
      ...
      <td><a href="post/edit_post.php?id=<?=$post["user_id"];?>">編集</a></td>
      <?php endif?>
      <?php if((isset($_SESSION["form"]) && $post["user_id"] ?? ""  == $_SESSION["form"]["id"]) || isset($_SESSION["admin"])):?>
      <td><a class = "delete" href= "post/delete_post.php?id=<?=$post["user_id"];?>">削除</a></td>
      <?php endif?>
    </div>
  </div>
  <?php endforeach?>
