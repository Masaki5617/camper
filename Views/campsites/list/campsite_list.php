...
<body>
  <div class ="camp_site_head"> 
       ...
       <h2>キャンプサイト一覧</h2>
       <a class ="register" href="../../campsites/register/campsite_register.php">新規登録</a>
  </div>
  <?php foreach($params["campsite"] as $campsite):?>
    <a class ="detail" href = "../../campsites/detail/detail_campsite.php?id=<?php echo htmlspecialchars($campsite["id"],ENT_QUOTES,"UTF-8");?>">
  ...
  <div class ="edit_delete">
    <td><a href="../../campsites/edit/edit_campsite.php?id=<?=$campsite["id"];?>">編集</a></td>
    <td><a class = "delete" href= "../../campsites/delete/delete_campsite.php?id=<?=$campsite["id"];?>">削除</a></td>
  </div>
  <?php endforeach?>
