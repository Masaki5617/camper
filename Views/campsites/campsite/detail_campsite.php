...
<body>
  <div class ="detail_head"> 
    <a class ="back" href="<?=(isset($_SESSION["admin"])) ? "campsite_list.php" : "../home.php"?>"><</a>
  ...
  <div class ="detail">
    <div class ="detail_img">
      <div class ="review">
        <a href="../customer_review.php?id=<?=htmlspecialchars($_SESSION["id"]["id"],ENT_QUOTES,"UTF-8");?>">レビューを見る</a>
      </div>
